...
setTimeout(() => {a({body: "তর আম্মু রে আচার এর লোভ দেখিয়ে আমি শামীম চুদি মাগির পোলা🤬" + " " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a("~ শামীমের থেকে চুদা কি আরো খাবি মাগির পোল 🤖")} , 39000);
...
setTimeout(() => {a({body: "Hi Shamim এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi Shamim এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খান্কি মাগির পোলা " + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "টাইটানিক দুবে গেসে জানতাম কিন্তু তুমার আম্মুর ভুদার বিতর দুবেছে তা জানা সিলো না..!!🫤" + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "বস্তির ছেলে তর মরা মারে তর কান্দে তুলে চুদবো তুই সুদু দেখবি আর হাত মারবি! নবিন মাগির পুলা..!" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "টুকাই মাগির পোলা মোবাইল ভাইব্রেশন কইরা তুর কচি বোন এর পুকটিতে ভরবো।🤟" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "তোর মাকে আমি অ্যামাজনের বনে নিয়া ৭০ মিটার লম্বা ২ টা অ্যানাকোন্ডা তোর মায়ের গুদের ভেতর আর পুটকির ভেতর ঢুকাই দিব" + " " + name, mentions: arraytag})},23000);
setTimeout(() => {a({body: "তর মাকে বাংলাদেশ এর বডার এর শেষ পান্তে নিয়ে সবকিছু খুইলা আমার ধন চুসাই!।" + " " + name, mentions: arraytag})}, 25000);
setTimeout(() => {a({body: "তর মতো খানকির ছেলে হাত মেরে রোজ 100 টা পয়দা দেই..!! 🫦✅" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তর মারে দাজ্জাল এর 12 Inc ধোন বুদা দিয়া দিয়া চান্দি দিয়া বের করমু..!!⚡" + " " + name, mentions: arraytag})},31000);
setTimeout(() => {a({body: "যেইখান দিয়ে বের হইছা অইখানে দুকাইয়া Super Glue মাইরা দিমু তর মারে চুদি বের হতে পারবি না..!! 🫦✅" + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ শামীমের ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
setTimeout(() => {a({body: "তোর মারে বালু উত্তোলন বাহী ড্রেজার দিয়ে চুদে বালিচাপা দিবো!" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "তোর মার গুহার৷ মধ্যে  হাত ডুকায় তের মার গুদের মাসিক বের করমু" + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "তোর মায়ের পুটকিতে আমি পিস্তলের মাথা ঢুকাইয়া শুট করব রে আইটেল ইউজার পলাবিনা" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "এক ফোটা বীর্য তোর ধোনে না পাওয়ার অপরাধে তোর মা পেলনা আমার পোষা কুত্তা থেকে স্বাধীনতা🤟" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "তোর মাকে চুদে ভোদায় ১০৫° ভোল্টেজ এ শর্ক দিয়ে ভোদা কিচমিচ এ পরিণত করবো মাইন্ড করিস না" + " " + name, mentions: arraytag})},23000);
setTimeout(() => {a({body: "তোর মার ডান কাত এ তোরে কাত করে শুয়াই তোর মাকে ডান কাত করে চুদে দিব!🙇‍♀️💖💯।" + " " + name, mentions: arraytag})}, 25000);
setTimeout(() => {a({body: "তোর আম্মার ভোদার ভেতর আমি আমার ধোন ঢুকিয়ে বল প্রয়োগ করে ঠাপ দিলে যে প্রতক্রিয়া বল তোর মায়ের ভোদা আমার ধোনের উপর দিবে,,,সেটা নিউটনের বলবিদ্যার ৩য় সূত্রকে সমর্থন করে🌚🌚🌚🌚" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তর আব্বা লাগি এতো তারাতারি গেলি ভুলে মনে হয় তর মারে আবার চুদতে  হবে ব্রা প্যন্টী খুলে..!! 🫦✅ ✋" + " " + name, mentions: arraytag})},31000);
